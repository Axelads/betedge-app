...
const FORME_CARTE = [
  'M 30,120', 'C 70,120 120,80 180,80', 'C 210,80 230,110 250,110',
  'C 270,110 290,80 320,80', 'C 380,80 430,120 470,120',
  'L 470,580', 'C 470,630 400,640 350,650',
  'Q 300,660 250,690', 'Q 200,660 150,650',
  'C 100,640 30,630 30,580', 'Z',
].join(' ')

const BORDURE_CARTE = [
  'M 35,123', 'C 75,123 125,83 180,83',
  'C 205,83 225,113 250,113', 'C 275,113 295,83 320,83',
  'C 375,83 425,123 465,123', 'L 465,577',
  'C 465,625 395,635 345,645', 'Q 300,655 250,683',
  'Q 200,655 155,645', 'C 105,635 35,625 35,577', 'Z',
].join(' ')
